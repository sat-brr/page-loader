...
FILES = {'tests/fixtures/pic1.png': "fixtures/pic1.png",
         'tests/fixtures/pic2.jpg': 'fixtures/pic2.jpg',
         'tests/fixtures/pics/pic3.png': 'pics/pic3.png',
         'tests/fixtures/scripts/script1.js': 'scripts/script1.js',
         'tests/fixtures/links/link1.css': 'links/link1.css'}
    ...
    with requests_mock.Mocker() as m:
        ...
        for path, url in FILES.items():
            with open(path, 'rb') as pic:
                tmp = pic.read()
            m.get(f'{TEST_URL}{url}', content=tmp)
